function PLdB = A2G_maritime(r, h, fc)
    ...
    a = 5.0188;  % Parameter for the Line-of-Sight (LoS) model
    b = 0.3511;  % Parameter for the Line-of-Sight (LoS) model
    hNLoS = 21; % Path loss for Non-Line-of-Sight (NLoS) in dB
    hLoS = 0.1;   % Path loss for Line-of-Sight (LoS) in dB
